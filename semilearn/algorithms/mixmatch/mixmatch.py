    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_w_2, **kwargs):
        ...
        with self.amp_cm():
            with torch.no_grad():
                ...
                outs_x_ulb_w2 = self.model(x_ulb_w_2)
                ...
                # avg
                avg_prob_x_ulb = (logits_x_ulb_w1 + logits_x_ulb_w2) / 2
            ...
            feat_dict = {"x_lb": feats_x_lb, "x_ulb_w": feat_x_ulb_w1, "x_ulb_w_2": feat_x_ulb_w2}
            for k in kwargs:
