...
class WideResNet(nn.Module):
    def __init__(self, first_stride, depth=28, widen_factor=2, drop_rate=0.0, **kwargs):
        ...
        self.regressor = nn.Linear(channels[3], 1)
    ...
    def forward(self, x, only_fc=False, only_feat=False, **kwargs):
        ...
        if only_fc:
            return self.regressor(x).flatten()
        ...
        output = self.regressor(out).flatten()
